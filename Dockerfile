...
RUN python3 -m pip install \
  git+https://github.com/openg2p/openg2p-fastapi-common@1.1.2\#subdirectory=openg2p-fastapi-common \
  git+https://github.com/openg2p/openg2p-fastapi-common@1.1.2\#subdirectory=openg2p-fastapi-auth \
