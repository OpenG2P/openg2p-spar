...
async def test_get_provider_by_type():
    ...
    with patch.object(service, 'get_provider_by_type', new_callable=AsyncMock) as mock_get:
...
async def test_get_provider_values():
    ...
    with patch.object(service, 'get_provider_values', new_callable=AsyncMock) as mock_get:
...
async def test_get_provider_value_by_code():
    ...
    with patch.object(service, 'get_provider_value_by_code', new_callable=AsyncMock) as mock_get:
...
async def test_provider_hierarchy():
    ...
    with patch.object(service, 'get_provider_value_by_code', new_callable=AsyncMock) as mock_get_code:
        with patch.object(service, 'get_children', new_callable=AsyncMock) as mock_get_children:
